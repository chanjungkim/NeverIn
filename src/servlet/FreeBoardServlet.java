...
////////////////////////////////////////////////////////////	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type == null || type.equals("freeboardList")) {
			...
			path = "freeboard_list.jsp";
		}else if(type.equals("writeForm")) {
			path = "freeboard_write_form.jsp";
			...
			if(freeboardarticle != null) {
				request.setAttribute("freeboardarticle", freeboardarticle);
				path = "freeboard_answer_form.jsp";
			}else {
				path = "article_not_found.jsp";
			}
			...
			if(service.delete(articleNum)) {
				path = "freeboard_delete_success.jsp";
			}else {
				path = "freeboard_delete_fail.jsp";
			}
			...
			if(freeboardarticle != null) {
				request.setAttribute("freeboardarticle", freeboardarticle);
				path = "freeboard_update_form.jsp";
			}else {
				path = "article_not_found.jsp";
			}
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("write")) {
			...
			if(result==true) {
				path = "freeboard_write_success.jsp";
			}else {
				path = "freeboard_write_fail.jsp";
			}
			...
			if(service.update(freeboardarticle)) {
				path = "freeboard_update_success.jsp";
			}else {
				path = "freeboard_update_fail.jsp";
			}
		}
